#!/usr/bin/env bash
# 编译 drop-in 版 dxgi.dll（PE32+ x86_64）
#
...
echo
echo "产物: $OUT"
echo "部署: 复制到游戏根目录（与 GTA5_Enhanced.exe 同级）:"
echo "  cp '$OUT' ~/.local/share/Steam/steamapps/common/'Grand Theft Auto V Enhanced'/"
